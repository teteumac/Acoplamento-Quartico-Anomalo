...
multiRP_TTbar = np.concatenate(  (TTbar , EfficienciesStudies(TTbar).reshape(-1,1)  ), axis = 1 )
...
'jetAK8_tau21', 'METPt', 'muon_pt', 'muon_eta', 'ExtraTracks', 'PUWeight', 'Yww','btag' ,'xi1', 'xi2','arm1', 'arm2', 'ismultirp_1','ismultirp_2', 'Mx', 'Yx', 'Mww/Mx', 'Yww_Yx','Norm', 'weight']


with h5py.File( 'DataSet_TTbar.h5', 'w') as f:
   dset = f.create_dataset( 'dados', data = DataFrame_multiRP_TTbar[select_columns_MC] )

print( 'DataFrame MultiRP TTbar\n', DataFrame_multiRP_TTbar[select_columns_MC] )
