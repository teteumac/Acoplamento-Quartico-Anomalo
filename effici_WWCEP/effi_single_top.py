...
multiRP_single_top = np.concatenate(  (single_top , EfficienciesStudies(single_top).reshape(-1,1) ), axis = 1 )
...
with h5py.File( 'DataSet_multiRP_single_top.h5', 'w') as f:
   dset = f.create_dataset( 'dados', data = DataFrame_multiRP_single_top[select_columns_MC] )
