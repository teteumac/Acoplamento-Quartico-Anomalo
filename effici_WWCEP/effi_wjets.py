...
def EfficienciesStudies( DataSet ):
    ...
    h_SF_ID_BC = f_SF_ID_BC.Get("NUM_TightID_DEN_genTracks_eta_pt;1")
...
WJets_100_250 = np.concatenate( ( WJets_100_250 ,EfficienciesStudies(WJets_100_250).reshape(-1,1),  weight_WJets_100_250  ) , axis = 1 )
...
WJets_250_400 = np.concatenate( ( WJets_250_400 , EfficienciesStudies(WJets_250_400).reshape(-1,1) , weight_WJets_250_400 ) , axis = 1 )
...
WJets_400_600 = np.concatenate( ( WJets_400_600 , EfficienciesStudies(WJets_400_600).reshape(-1,1) ,  weight_WJets_400_600  ) , axis = 1 )
...
WJets_600_inf = np.concatenate( ( WJets_600_inf , EfficienciesStudies(WJets_600_inf).reshape(-1,1) , weight_WJets_600_inf  ) , axis = 1 )
...
'Mww/Mx', 'Yww_Yx','EfficienciesStudies', 'weight']
...
'jetAK8_tau21', 'METPt', 'muon_pt', 'muon_eta', 'ExtraTracks', 'PUWeight', 'Yww','btag', 'xi1', 'xi2', 'arm1', 'arm2', 'ismultirp_1','ismultirp_2', 'Mx', 'Yx', 'Mww/Mx', 'Yww_Yx','EfficienciesStudies', 'weight']

DataFrame_multiRP_WJets = pd.DataFrame(WJets, columns = columns_MC )

print( DataFrame_multiRP_WJets )

with h5py.File( 'DataSet_multiRP_WJets.h5', 'w') as f:
   dset = f.create_dataset( 'dados', data = DataFrame_multiRP_WJets[select_columns_MC] )

print( DataFrame_multiRP_WJets[select_columns_MC] )
