...
echo 'Running...'
echo python3 $EXEC/workspace_WW.py --files=$file --label=$label $option1 $option2 $option3 $option4 $option5 $option6
python3 $EXEC/workspace_WW.py --files=$file --label=$label $option1 $option2 $option3 $option4 $option5 $option6
cp *.h5 $OUTPUT
